...
public class SceneManager {
     ...
     * applies global cursor and button animations, and sets the scene to full
     * screen.
     *
     ...
     * {@code /scenes/[sceneName]View/[sceneName].fxml}, applies global cursor
     * settings
     * and animations to all buttons, and updates the root of the main scene.
     *
     * @param sceneName the name of the scene to switch to (must match the FXML
