...
/**
 * Manages animations and cursor effects for the application.
 * 
...
public class AnimationsManager {
    ...
    static {
        cursorDefault = new ImageCursor(new Image(Objects.requireNonNull(AnimationsManager.class
                .getResourceAsStream("/com/example/myfirstnavalbattle/Images/sceneImages/CURSORDEFAULT.png"))));
        cursorHover = new ImageCursor(
                new Image(Objects.requireNonNull(AnimationsManager.class
                        .getResourceAsStream("/com/example/myfirstnavalbattle/Images/sceneImages/CURSORHOVER.png"))),
                28, 28);
        cursorPressed = new ImageCursor(
                new Image(Objects.requireNonNull(AnimationsManager.class
                        .getResourceAsStream("/com/example/myfirstnavalbattle/Images/sceneImages/CURSORPRESSED.png"))),
                28, 28);
    }
